          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg mb-8">
              ...
              <div className="text-left space-y-3 text-gray-600">
                <p>
                  • A critical error occurred that prevented the page from rendering
                </p>
                <p>
                  • This is a more serious issue than a regular page error
                </p>
                <p>
                  • Our development team has been automatically notified
                </p>
                <p>
                  • Please try refreshing or returning to the homepage
                </p>
              </div>
            </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-gray-600 mb-4">
                If this problem continues, please contact our support team immediately.
              </p>
              <Link 
                href="/contact" 
