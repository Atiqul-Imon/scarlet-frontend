                    ...
                    <div className="mb-6 p-4 bg-purple-50 border border-purple-200 rounded-lg">
                      ...
                      <div className="flex items-center gap-2 mb-2">
                        <input
                          ...
                          className="flex-1 px-3 py-2 border border-purple-300 rounded-lg bg-white text-gray-900 font-medium focus:ring-2 focus:ring-purple-500 focus:border-purple-500 disabled:bg-gray-100 disabled:text-gray-500 disabled:cursor-not-allowed"
                          placeholder="Enter credits to redeem"
                          style={{ color: creditsToRedeem ? '#111827' : '#6B7280' }}
                        />
                        <button
                          type="button"
                          onClick={() => {
