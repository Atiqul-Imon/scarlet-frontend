        ...
        <div className="container-herlan">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full px-6 py-4 bg-red-700 text-white rounded-lg hover:bg-red-800 transition-colors font-medium disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
                  {isSubmitting ? (
                    <>
            ...
            <div>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+8801234567890" className="hover:text-red-700 transition-colors">
                        +880 1234 567 890
                      </a>
                    </p>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:hello@scarlet.com" className="hover:text-red-700 transition-colors">
                        hello@scarlet.com
                      </a>
                    </p>
                    <p className="text-sm text-gray-500 mt-1">
              ...
              {/* FAQ Link */}
              <div className="mt-12 p-6 bg-gradient-to-r from-red-50 to-purple-50 rounded-2xl">
